...
export const setMealCompletion = async (
    ...
    const completionPayload = {
      ...
      .single();
      if (error) {
        console.error("Error setting meal completion:", error);        return { success: false, error };
      }
...
export const getMealCompletions = async (
    mealPlanId,
      ...
      if (error) {
        console.error("Error getting meal completion:", error);        return { success: false, error };
      }
      return { success: true, data };
};
